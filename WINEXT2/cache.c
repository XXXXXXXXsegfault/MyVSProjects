...
long long global_cache_start_addr[GLOBAL_CACHE_PAGES_MAX];
long long global_cache_write_mark[GLOBAL_CACHE_PAGES_MAX];
int global_cache_page_find(long long addr)
{
	int n,best_n;
	long long best_addr,val;
	n=0;
	best_n=-1;
	best_addr=-1;
...
int global_cache_use(long long addr)
{
	int n;
	n=0;
	while(n<GLOBAL_CACHE_PAGES_MAX)
...
void ext2_read_block(unsigned long long bn,void *buf)
{
...
void ext2_write_block(unsigned long long bn,void *buf)
{
	int block_size_shift;
	int bn_lo;
	int cache_n;
